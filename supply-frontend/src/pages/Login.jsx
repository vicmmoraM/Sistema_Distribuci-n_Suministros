          ...
          <form onSubmit={handleSubmit} className="login-form">
            ...
            {error && (
              <div className="error-alert">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 20 20" style={{ width: '20px', height: '20px', minWidth: '20px', minHeight: '20px' }}>
            ...
            <button
              ...
              {loading ? (
                <>
                  <svg className="animate-spin" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" style={{ width: '20px', height: '20px', minWidth: '20px', minHeight: '20px' }}>
